...
; (function ($, window, document, Math, undefined) {
    ...
    var MiSlider = function (stageEl, options) {
        ...
        o.optionsInit = {
            ...
            //当前幻灯片的相对比例缩放因子
            //其他幻灯片按比例缩小。为100或更高。100代表没有缩放。
            slideScaling: 100,//---------------做改变没反应
            ...
            //滑动中心的垂直偏移量作为滑动高度的一个百分比。
            //正面或负面的数字。负值=上。正值=下。0 =无偏移。
            offsetV: 0,//---------------做改变没反应
            ...
            //CSS样式classStage将应用于mis-stage元素。
            classStage: "mis-stage",
            // The CSS class that will be applied to the slider element.
            //CSS样式classSlider将应用于mis-slider元素。
        ...
        o.setup = function () {
            ...
            o.slides.each(function () {
                ...
                //width = slide.outerWidth();/*----------------------------12.3卜令梅*/
                width = slide.outerWidth() - 120;/*----------------------------12.3卜令梅*/
            ...
            //计算幻灯片缩放、宽度、增量和幻灯片和关闭阶段

            // Determine the maximum number of slides that fit on the stage
            //确定适合在stage上的幻灯片的最大数量
            //slidesMaxNum = Math.floor((o.stageWidth - o.slideWidthCurrent) /
            //    (o.slideWidthCurrent * 100 / o.slideScaling))+1 ;/*----------------------------------------12.3卜令梅*/
            slidesMaxNum = Math.floor((o.stageWidth - o.slideWidthCurrent) /
                (o.slideWidthCurrent * 100 / o.slideScaling)) - 3;
            ...
            if (o.slidesOnStage > 1) {
                ...
                //修改当前的幻灯片宽度，以适应正确的幻灯片幻灯片的数量在stage上
            ...
            //o.scalingMargin = (o.slideWidth - o.scalingWidth) / 2 - 15;/*-------------------12.3卜令梅*/
            o.scalingMargin = (o.slideWidth - o.scalingWidth) / 2 - 15;
            ...
            o.sliderWidth = o.slideWidthCurrent + (o.slideWidth * (o.slidesLength - 1));

            // Set CSS of slider
            o.slider
                .css({
                    //"left": leftOffsetter(o.indexCurrent),/*----------------12.3卜令梅*/
                    "left": leftOffsetter(o.indexCurrent) + 40,
                    "width": o.sliderWidth
                })
            ;
